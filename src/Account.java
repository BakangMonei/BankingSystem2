...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        AccountPage.setBackground(new java.awt.Color(153, 153, 255));
        ...
        EthnicityAP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "African", "Black American", "Asian", "Batswana", "Indian/Asian", "Other" }));
        ...
        AcctypeAP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Savings Account", "Debit Account", "Fixed deposit account.", "Salary Account", "NRI accounts.", " ", " ", " " }));
        ...
        SecurityqAP.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "What is the name of your first Bank?", "What is the name of your country?", "What is the name of your favouite lecturer?", "What is your nickname?" }));
